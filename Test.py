# %%
from ChessScraper.ChessComData import (get_player_data, get_names_by_title,
...
for player in names["GM"]:
    ...
    #saving to disk
    save_player_games('output_data',player_games,player,s3Client,disk_or_cloud="disk")
    #saving to cloud s3
    save_player_games('output_data',player_games,player,s3Client,disk_or_cloud="cloud",bucket='chess-games-js')
